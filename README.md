...
```bash
git clone https://github.com/furinehigh/Koinonia.git
cd Koinonia
```
2. Rename the `.env.example` file to `.env` and put all the required variable there such as Github OAuth client and secret..
